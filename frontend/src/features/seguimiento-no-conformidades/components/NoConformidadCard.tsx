    ...
    <Link to={`/seguimiento-no-conformidades/${noConformidad.id_no_conformidad}`}>
      ...
      >
        ...
        <div className="flex items-start justify-between gap-2 mb-2">
          ...
          {estaVencida && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 border border-red-200 flex-shrink-0">
