  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm text-gray-500 file:mr-3 file:py-2 file:px-3 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer"
            />
      ...
      <Card compact title={`Archivos (${archivosData?.total || 0})`}>
        {isLoading ? (
          <p className="text-sm text-gray-500 text-center py-4">Cargando archivos...</p>
            ...
            <table className="min-w-full text-sm divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {archivosData?.archivos.map((archivo) => {
                  ...
                  return (
                    <tr key={archivo.id_archivo} className="hover:bg-gray-50">
