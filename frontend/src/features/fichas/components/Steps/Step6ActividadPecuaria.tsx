    ...
    <div className="space-y-6">
      ...
      <FormSection>
        ...
        <div className="flex justify-end mb-4">
          <Button type="button" onClick={handleAddActividad} variant="primary" size="medium">
                ...
                fields.map((field, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Controller
                        name={`actividades_pecuarias.${index}.tipo_ganado` as const}
                        control={control}
                    ...
                    <td className="px-4 py-3 border-l border-neutral-border">
                      <Controller
                        name={`actividades_pecuarias.${index}.animal_especifico` as const}
                        control={control}
                        render={({ field: fieldProps }) => (
                          <input
                            {...fieldProps}
                    ...
                    <td className="px-4 py-3 border-l border-neutral-border">
                      <Controller
                        name={`actividades_pecuarias.${index}.cantidad` as const}
                        control={control}
                        render={({ field: fieldProps }) => (
                          <input
                            {...fieldProps}
                    ...
                    <td className="px-4 py-3 border-l border-neutral-border">
                      <Controller
                        name={`actividades_pecuarias.${index}.sistema_manejo` as const}
                        control={control}
                        render={({ field: fieldProps }) => (
                          <input
                            {...fieldProps}
                    ...
                    <td className="px-4 py-3 border-l border-neutral-border">
                      <Controller
                        name={`actividades_pecuarias.${index}.uso_guano` as const}
                        control={control}
                        render={({ field: fieldProps }) => (
                          <textarea
                            {...fieldProps}
